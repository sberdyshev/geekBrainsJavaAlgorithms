...
class StackImplTest {
    ...
    public void setUpTest() {
        stackString = new StackImpl<>("String stack", "Test1", "Test2", "Test456");
        stackStringEmpty = new StackImpl<>("String empty stack");
        stackInteger = new StackImpl<>("Integer stack", 10, 59, 1111, 123);
        stackIntegerEmpty = new StackImpl<>("Integer empty stack");
    }
