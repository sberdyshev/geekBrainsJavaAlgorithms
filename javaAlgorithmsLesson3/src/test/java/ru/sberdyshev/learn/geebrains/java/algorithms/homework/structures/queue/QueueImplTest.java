...
class QueueImplTest {
    ...
    public void setUpTest() {
        queueString = new QueueImpl<>(String.class, "String queue", "Test1", "Test2", "Test456");
        queueStringEmpty = new QueueImpl<>(String.class, "String empty queue");
        queueInteger = new QueueImpl<>(Integer.class, "Integer queue", 10, 59, 1111, 123);
        queueIntegerEmpty = new QueueImpl<>(Integer.class, "Integer empty queue");
    }
