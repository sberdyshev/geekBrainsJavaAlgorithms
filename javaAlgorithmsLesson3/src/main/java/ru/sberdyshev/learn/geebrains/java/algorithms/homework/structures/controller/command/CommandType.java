...
public enum CommandType {
    CREATE_STACK("/crtSt", "create stack", "Creates a stack with specified name. Format - \"/crtSt <stack name (string)>\".", 1),
    DELETE_STACK("/dltSt", "delete stack","Deletes a stack with specified name. Format - \"/dltSt <stack name (string)>\".", 1),
    ...
    SHOW_STACK_SIZE("/shSSz", "show stack size","Prints stack size. Format - \"/shSSz <stack name (string)>\".", 1),
    ...
    SHOW_QUEUE_SIZE("/shQSz", "show queue size","Prints queue size. Format - \"/shQSz <queue name (string)>\".", 1),
